...
const NAV_LINKS = [
  { href: "https://gigaverse.io", icon: <GlobeIcon />, label: "Website" },
  { href: "https://x.com/playgigaverse", icon: <XIcon />, label: "X" },
  { href: "https://discord.gg/glhfers", icon: <DiscordIcon />, label: "Discord" },
];
  ...
  return (
    <header
      style={{
        ...
        background: "linear-gradient(180deg, rgba(8,13,20,0.98) 0%, rgba(8,13,20,0.95) 100%)",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", flexShrink: 0 }}>
          ...
          >
            <Image src="/logo.png" alt="Gigaverse" width={32} height={32} style={{ objectFit: "cover" }} />
          </div>
          <span
            style={{
